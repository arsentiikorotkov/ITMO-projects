...
#### Множество на массиве (package arrayset)

1.  Разработайте класс `ArraySet`, реализующий неизменяемое упорядоченное множество.
    *   Класс `ArraySet` должен реализовывать интерфейс [SortedSet](https://docs.oracle.com/en/java/javase/19/docs/api/java.base/java/util/SortedSet.html).
    *   Все операции над множествами должны производиться с максимально возможной асимптотической эффективностью.
2.  При выполнении задания следует обратить внимание на:
    *   Применение стандартных коллекций.
    *   Избавление от повторяющегося кода.

#### Студенты (package student)
...
#### Implementor (package implementor)
...
#### Jar Implementor (package implementor)
...
#### Итеративный параллелизм (package concurrent)
...
5.  При выполнении задания **нельзя** использовать _Concurrency Utilities_.

#### Параллельный запуск (package concurrent)
...
#### HelloNonblockingUDP (package hello)
