    ...
    private inner class TransferOp(val fromIndex: Int, val toIndex: Int, val amount: Long) : Op() {
        ...
        override fun invokeOperation() {
            ...
            if (fromIndex <= toIndex) {
                account1 = acquire(fromIndex, this) ?: return
                account2 = acquire(toIndex, this) ?: return
            } else {
                account2 = acquire(toIndex, this) ?: return
                account1 = acquire(fromIndex, this) ?: return
            }
            ...
            when {
                amount > account1.amount -> errorMessage = "Underflow"
                account2.amount + amount > MAX_AMOUNT -> errorMessage = "Overflow"
                else -> {
                    account1.newAmount = account1.amount - amount
                    account2.newAmount = account2.amount + amount
                }
            }
